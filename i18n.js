(function () {
  ...
  const sv = {
    ...
    "Chain attacks. Break pressure. Win the exchange.": "Kedja attacker. Bryt press. Vinn utbytet.",
    "ChainGrapplers is a head-to-head card game about timing, position, and tactics. The boxed game is the main event, but please try the digital demo so you can feel the system before it hits the table.": "ChainGrapplers är ett kortspel för två spelare om tajming, position och taktik. Det fysiska spelet är huvudupplevelsen, men testa gärna den digitala demon för att känna systemet innan korten hamnar på bordet.",
    "Try it": "Testa",
    "Test the core flow in the browser and feel how the chain system works.": "Testa grundflödet i webbläsaren och känn hur kedjesystemet fungerar.",
    "See What Drives the Pressure": "Se vad som skapar pressen",
    "Get the quick picture of why the system feels tense, tactical, and replayable.": "Få en snabb bild av varför systemet känns spänt, taktiskt och omspelbart.",
    "Buy it": "Köp det",
    "Learn what the boxed game is and where the real table experience belongs.": "Läs om det fysiska spelet och var den riktiga bordsupplevelsen hör hemma.",
    "Read the Rules": "Läs reglerna",
    "Start with the short version, then move into the exact chain and card rules.": "Börja med den korta versionen och gå sedan vidare till de exakta kedje- och kortreglerna.",

    "Inside ChainGrapplers": "Om ChainGrapplers",
    "Learn how ChainGrapplers turns Brazilian Jiu-Jitsu positions, submissions, escapes, and pressure into a tactical head-to-head card game.": "Lär dig hur ChainGrapplers gör brasiliansk jiu-jitsus positioner, submissions, escapes och press till ett taktiskt kortspel för två.",
    "A tactical BJJ card game built around position, pressure, submissions, and escapes.": "Ett taktiskt BJJ-kortspel byggt runt position, press, submissions och escapes.",
    "A tactical grappling duel built for the table, not the screen.": "En taktisk grapplingduell byggd för bordet, inte skärmen.",
    "ChainGrapplers is about sequence quality. Better transitions create better pressure, better pressure creates better finishing chances, and one bad response can flip the whole exchange.": "ChainGrapplers handlar om kvaliteten i sekvensen. Bättre övergångar skapar bättre press, bättre press skapar bättre avslutslägen, och ett dåligt svar kan vända hela utbytet.",
    "Position": "Position",
    ...
    "Submissions demand an answer immediately, which gives the end of the chain real weight.": "Submissions kräver ett svar direkt, vilket gör slutet av kedjan betydelsefullt.",
    "Why It Works": "Varför det fungerar",
    "A BJJ gift kids can actually play": "En BJJ-present som barn faktiskt kan spela",
    "ChainGrapplers is a Brazilian Jiu-Jitsu card game made for families, kids, and teammates, not only experienced grapplers. If you are looking for a": "ChainGrapplers är ett brasilianskt jiu-jitsu-kortspel gjort för familjer, barn och träningskompisar, inte bara erfarna grapplers. Om du letar efter en",
    ...
    "ChainGrapplers is a Brazilian Jiu-Jitsu card game made for families, kids, and teammates, not only experienced grapplers. If you are looking for a BJJ gift, Jiu-Jitsu accessory, or martial arts game for a child who trains, it gives them a way to bring the academy home.": "ChainGrapplers är ett brasilianskt jiu-jitsu-kortspel gjort för familjer, barn och träningskompisar, inte bara erfarna grapplers. Om du letar efter en BJJ-present, en jiu-jitsu-pryl eller ett kampsportsspel till ett barn som tränar, ger det dem ett sätt att ta hem känslan från klubben.",
    "You do not need to know BJJ to play. The colors and card flow make the game easy to learn, while quietly teaching how positions, pressure, escapes, and submissions connect. Parents and grandparents can play along, and young grapplers get a better understanding of the sport they already love.": "Du behöver inte kunna BJJ för att spela. Färgerna och kortflödet gör spelet lätt att lära sig, samtidigt som det visar hur positioner, press, escapes och submissions hänger ihop. Föräldrar och mor- eller farföräldrar kan spela med, och unga grapplers får en bättre förståelse för sporten de redan älskar.",
    "BJJ Positions": "BJJ-positioner",
    "The position ladder behind the cards": "Positionsstegen bakom korten",
    "ChainGrapplers uses grappling positions as the pressure map for the game. Each card moves the exchange from a starting position toward a better, worse, or more dangerous position. Depending on what side of the table you are sitting on.": "ChainGrapplers använder grapplingpositioner som spelets presskarta. Varje kort flyttar utbytet från en startposition mot en bättre, sämre eller farligare position beroende på vilken sida av bordet du sitter på.",
    ...
    "Mount/Full Guard represents stronger positional pressure. The attacker has control and direct access to serious submission threats.": "Mount/Full guard representerar starkare positionell press. Angriparen har kontroll och direkt tillgång till farliga submissionhot.",
    ...
    "Submissions are the finishers in Brazilian Jiu-Jitsu. In ChainGrapplers, they are represented by red pressure: once a submission is active, the defender cannot ignore it, and only a last Hail Mary escape can keep the match alive.": "Submissions är avsluten i brasiliansk jiu-jitsu. I ChainGrapplers representeras de av röd press: när en submission är aktiv kan försvararen inte ignorera den, och bara en sista Hail Mary-escape kan hålla matchen vid liv.",
    "Armbar": "Armbar",
    ...
    "Bring the pressure to the table.": "Ta pressen till bordet.",
    ...
    "Learn the game fast, then check the full rules.": "Lär dig spelet snabbt och läs sedan de fullständiga reglerna.",
    ...
    "On your turn, you may play up to 2 cards.": "På din tur får du spela upp till 2 kort.",
    ...
    "draw from the pile. If the Hail Mary card is not playable on the submission, the defender has been submitted.": "dragning från högen. Om Hail Mary-kortet inte kan spelas på submissionen har försvararen blivit submitted.",
    ...
    "Think of every normal card as a positional transition.": "Tänk på varje normalt kort som en positionsövergång.",
    "Green": "Grön",
    ...
    "Red": "Röd",
    ": submission threat or submission escape.": ": submissionhot eller submission-escape.",
    "Defensive cards": "Defensiva kort",
    "pull the exchange back toward near-neutral half guard.": "drar utbytet tillbaka mot nästan neutral half guard.",
    ...
    "If a player plays a defensive card, the next normal response is offense.": "Om en spelare spelar ett defensivt kort är nästa normala svar offensiv.",
    "If an attacker still has a second legal offensive card, they may continue the attack on the same turn.": "Om angriparen fortfarande har ett andra lagligt offensivt kort får attacken fortsätta på samma tur.",
    "Turn structure": "Turstruktur",
    "You may play up to 2 cards on your turn.": "Du får spela upp till 2 kort på din tur.",
    "You may choose to stop and draw even if you still have a legal move.": "Du får välja att stanna och dra även om du fortfarande har ett lagligt drag.",
    "If": "Om",
    "is in your hand, drawing is blocked. You must either play a legal card, or end the turn without drawing.": "finns på handen är dragning blockerad. Du måste antingen spela ett lagligt kort eller avsluta turen utan att dra.",
    "Submissions": "Submissions",
    "A red offensive card creates an active submission threat.": "Ett rött offensivt kort skapar ett aktivt submissionhot.",
    "When you are under submission, you may not draw, pass, or end turn unless the Hail Mary rule triggers.": "När du är under submission får du inte dra, passa eller avsluta turen om inte Hail Mary-regeln triggas.",
    ...
    "If the Hail Mary card is an escape card, play it immediately and continue as normal. If it is not an escape card, you are submitted and lose immediately.": "Om Hail Mary-kortet är ett escape-kort spelas det direkt och spelet fortsätter som vanligt. Om det inte är ett escape-kort blir du submitted och förlorar direkt.",
    "Special Cards": "Specialkort",
    ": draw 3 cards. It counts as one played card. The chain does not change, and the card is thrown into the discard pile.": ": dra 3 kort. Det räknas som ett spelat kort. Kedjan ändras inte och kortet läggs i högen för använda kort.",
    ": play it into the chain. The next card may be any legal follow-up.": ": spela det in i kedjan. Nästa kort får vara vilken laglig uppföljning som helst.",
    ": play it into the chain, then pick up the most recently played card, except Takedown. The next card may be any legal follow-up.": ": spela det in i kedjan och plocka sedan upp det senast spelade kortet, förutom Takedown. Nästa kort får vara vilken laglig uppföljning som helst.",
    ": can only be played as your first and only card of the turn. After Fatigue, the next player may play any card.": ": kan bara spelas som ditt första och enda kort på turen. Efter Fatigue får nästa spelare spela vilket kort som helst.",
    "cards: steal 1 random card from your opponent. The chain does not change, and the card is thrown into the discard pile.": "kort: stjäl 1 slumpmässigt kort från motståndaren. Kedjan ändras inte och kortet läggs i högen för använda kort.",
    "Winning": "Vinst",
    ": if your opponent cannot answer an active submission and fails the Hail Mary draw, you win.": ": om din motståndare inte kan svara på en aktiv submission och misslyckas med Hail Mary-dragningen vinner du.",
    "Card advantage": "Kortövertag",
    ": if the deck is exhausted and the chain can no longer continue, the player with fewer cards left wins.": ": om leken är slut och kedjan inte längre kan fortsätta vinner spelaren med färre kort kvar.",
    "Draw": "Oavgjort",
    ...
    "No legal cards to play. Use the highlighted button to draw and pass the turn.": "Inga lagliga kort att spela. Använd den markerade knappen för att dra och passa turen.",
    "Fatigue is in your hand. Play a legal card before you can end the turn.": "Fatigue finns på handen. Spela ett lagligt kort innan du kan avsluta turen.",
    ...
    "Play up to two legal cards, then draw to pass the turn.": "Spela upp till två lagliga kort och dra sedan för att passa turen.",
    "move": "drag",
    "in-chain escape": "escape i kedjan",
    "follow-up move": "uppföljningsdrag",
    "offensive move": "offensivt drag",
    "defensive move": "defensivt drag",
    "No escape in hand. Take the Hail Mary draw.": "Ingen escape på handen. Ta Hail Mary-dragningen.",
    "Submission active. Escape if possible!": "Submission aktiv. Escapa om du kan!",
    "Fatigue blocks drawing and you have no legal move.": "Fatigue blockerar dragning och du har inget lagligt drag.",
    "Draw a card.": "Dra ett kort.",
    "End turn.": "Avsluta turen.",
    "You have no legal move. {nextAction}": "Du har inget lagligt drag. {nextAction}",
    ...
    "Fatigue blocks drawing. You may play a legal card.": "Fatigue blockerar dragning. Du kan spela ett lagligt kort.",
    "Fatigue blocks drawing. Play a legal follow-up or end turn.": "Fatigue blockerar dragning. Spela en laglig uppföljning eller avsluta turen.",
    "or end turn.": "eller avsluta turen.",
    "or draw a card.": "eller dra ett kort.",
    "Play a legal move {nextAction}": "Spela ett lagligt drag {nextAction}",
    ...
    "escaped a submission": "escapade en submission",
    ...
    "submission": "submission",
    "empty hand": "tom hand",
    "No escape in hand. Draw one Hail Mary card from the pile.": "Ingen escape på handen. Dra ett Hail Mary-kort från högen.",
    "Hail Mary found an escape. The match continues.": "Hail Mary hittade en escape. Matchen fortsätter.",
    "{winner} wins by submission. Hail Mary failed: {cardTitle} was not an escape.": "{winner} vinner genom submission. Hail Mary misslyckades: {cardTitle} var inte en escape.",
    ...
    "That card is not legal now.": "Det kortet är inte lagligt nu.",
    ...
    "{player} holds 53 and cannot pass/draw.": "{player} håller 53 och kan inte passa/dra.",
    "{player} ends the turn without drawing because of Fatigue.": "{player} avslutar turen utan att dra på grund av Fatigue.",
    "No cards left and no legal moves. Draw game.": "Inga kort kvar och inga lagliga drag. Oavgjort."
  };
