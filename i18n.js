(function () {
  ...
  const sv = {
    ...
    "If a submission is active, the defender must answer with an escape. If they have no playable card, they get one": "Om en submission är aktiv måste försvararen svara med en escape. Om spelaren inte har något spelbart kort får spelaren ett",
    "draw from the pile. If the Hail Mary card is not playable on the submission, the defender has been submitted.": "från högen. Om chanskortet inte kan spelas på submissionen har försvararen blivit avslutad.",
    ...
    "pull the exchange back toward near-neutral half guard.": "drar utbytet tillbaka mot neutral half guard.",
    ...
    ". With no playable card, one": ". Utan spelbart kort kan ett",
    "draw can save them.": "rädda spelaren.",
    ...
    "Winning": "Vinst",
    ": if your opponent cannot answer an active submission and fails the Hail Mary draw, you win.": ": om din motståndare inte kan svara på en aktiv submission och misslyckas med chanskortet vinner du.",
    "Card advantage": "Kortövertag",
    ": if the deck is exhausted and the chain can no longer continue, the player with fewer cards left wins.": ": om leken är slut och kedjan inte längre kan fortsätta vinner spelaren med färre kort kvar på handen.",
    "Draw": "Oavgjort",
    ...
    "No escape in hand. Take one Hail Mary draw from the pile.": "Ingen escape på handen. Dra ett chanskort från högen.",
    ...
    "No escape in hand. Take the Hail Mary draw.": "Ingen escape på handen. Ta chanskortet.",
    ...
    "escaped a submission": "flydde från en submission",
    ...
    "wins": "vinner",
    "empty hand": "tom hand",
    "No escape in hand. Draw one Hail Mary card from the pile.": "Ingen escape på handen. Dra ett chanskort från högen.",
    "Hail Mary found an escape. The match continues.": "Chanskortet var en escape. Matchen fortsätter.",
    "{winner} wins by submission. Hail Mary failed: {cardTitle} was not an escape.": "{winner} vinner genom submission. Chanskortet misslyckades: {cardTitle} var inte en escape.",
